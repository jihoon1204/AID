...
=======
video_frame1 = tk.Frame(root, bg='white', width=500, height=400, bd=1, relief=tk.SOLID)
video_frame1.place(x=10, y=40)
video_frame2 = tk.Frame(root, bg='white', width=500, height=400, bd=1, relief=tk.SOLID)
video_frame2.place(x=510, y=40)
video_frame3 = tk.Frame(root, bg='white', width=500, height=400, bd=1, relief=tk.SOLID)
video_frame3.place(x=10, y=440)
video_frame4 = tk.Frame(root, bg='white', width=500, height=400, bd=1, relief=tk.SOLID)
video_frame4.place(x=510, y=440)

video_label1 = tk.Label(video_frame1, bg='white', width=400, height=800, bd=1, relief=tk.SOLID)
video_label1.place(x=8,y=10)
>>>>>>> bbbb034af06b35f929ed9b2acf9ad6a366dd5f23
...
=======
vb1 = VideoBox(address='경남 진주시 진주대로 501 경상국립대학교 공과대학 407동 202호', frame=video_frame1, label=video_label1, source=0, board=board)
>>>>>>> bbbb034af06b35f929ed9b2acf9ad6a366dd5f23
